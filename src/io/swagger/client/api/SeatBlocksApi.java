...
import io.swagger.client.model.SeatBlocksList;
...
public class SeatBlocksApi {
   ...
   * Retrieve existing seat blocks\n\n The result is limited by the permissions of the apiKey.\n\n &lt;p/&gt;\n\n It is possible to filter by time blocked and/or time of the last\nchange.\n\n To filter by time blocked, the parameters startTime and endTime are\nrequired.\n\n To filter by last time changed, the parameters lastUpdatedStartTime and\nlastUpdatedEndTime are required.\n\n It is possible to filter by both at the same time. At least one of the\ntwo filters must be used.\n\n &lt;p/&gt;\n\n It is further possible to filter by product id.
